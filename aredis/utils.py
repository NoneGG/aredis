...
_CYTHON_EXTENSION_SPEEDUP = False
try:
    from aredis.speedups import (crc16, hash_slot, b,
                                 nativestr, encode,
                                 pack_command, pack_commands)

    _CYTHON_EXTENSION_SPEEDUP = True
except Exception:
    pass

if not _CYTHON_EXTENSION_SPEEDUP:
    ...
    def pack_command(encoding, args):
    ...
    def pack_commands(encoding, commands):
