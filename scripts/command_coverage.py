...
print(
    generate_compatibility_section(
        "Redis Client", kls, sync_kls, "redis.commands.core.CoreCommands", STD_GROUPS + ["server", "connection"]
    )
)
...
print(
    generate_compatibility_section(
        "Redis Cluster Client", cluster_kls, sync_cluster_kls, "redis.commands.cluster.RedisClusterCommands", STD_GROUPS + ["cluster"]
    )
)
